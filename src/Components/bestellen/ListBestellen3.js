    ...
    return (
        <div>
            <List>
                ...
                <ListItem className="listitem" checked={checked3} onClick={handleChange3} >
                    <ListItemAvatar className="listItemAvatar">
                        <img src={Vogel} alt="not found" width="60" height="60" />
                    </ListItemAvatar>
                    <ListItemText className="listItemText">
                        <Typography variant="h5">
                            <TableCell className="cell1">Vogel</TableCell>
                        ...
                        <Card className={classes.countCard}>
                            <CardContent className={classes.contentCount}>
                                <Grid container item justify="center" alignItems="center" direction="row">
                                    ...
                                    <Grid item container justify="center" alignItems="center" xs={2}>
                                        <TextField maxValue='3' type='number' id="outlined-basic" InputProps={{ style: { fontSize: 40 } }} variant="outlined" value={count3} />
                                    </Grid>
                                    <Grid item container justify="center" alignItems="center" xs={4}>
                                        <AddCircleIcon style={{ fontSize: 100 }} color='secondary' onClick={vogelAdd} />
                                    </Grid>
                                </Grid>
                            </CardContent>
                        </Card>
